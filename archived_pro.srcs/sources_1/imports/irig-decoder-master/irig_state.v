module irig_state (
    ...
    always @(*) begin
        ...
        case (state)
          ...
          ST_HOUR: begin
                if(irig_d1) 
                       begin
                        hrs_frame[irig_cnt] = 1'b1;
                       end
                       else if(irig_d0) 
                            begin
                            hrs_frame[irig_cnt] = 1'b0;
                            end 
                            else if (irig_mark)
                                     next_state = ST_DAY;
          ...
          ST_DAY: begin
              if(irig_d1) 
              begin
              days_frame[irig_cnt] = 1'b1;
              end
              else if(irig_d0) 
                   begin
                   days_frame[irig_cnt] = 1'b0;
                   end 
                   else if (irig_mark)
                        next_state = ST_DAY2;
          ...
          ST_DAY2: begin
                if(irig_d1) 
                        begin
                        days2_frame[irig_cnt] = 1'b1;
                        end
                        else if(irig_d0) 
                             begin
                             days2_frame[irig_cnt] = 1'b0;
                             end 
                             else if (irig_mark)
                                  next_state = ST_YEAR;
    ...
    assign hrs_data_u = hrs_frame[3:0];
    assign hrs_data_t = hrs_frame[6:5];
    assign days_data_u = days_frame[3:0];
    assign days_data_t = days_frame[8:5];
    assign days_data_h = days2_frame[1:0];
