...
HD_PWD='G:/my_project_reader/seq_detector/seq_detector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_dector.vds -m64 -mode batch -messageDb vivado.pb -notrace -source seq_dector.tcl
