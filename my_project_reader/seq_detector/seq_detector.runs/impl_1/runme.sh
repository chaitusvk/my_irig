...
HD_PWD='G:/my_project_reader/seq_detector/seq_detector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_dector.vdi -applog -m64 -messageDb vivado.pb -mode batch -source seq_dector.tcl -notrace
