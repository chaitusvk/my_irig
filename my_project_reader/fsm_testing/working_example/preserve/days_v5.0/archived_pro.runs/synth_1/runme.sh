...
HD_PWD='G:/arty/IRIG_READER_LOGIC/archived_pro/archived_pro.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log irig.vds -m64 -mode batch -messageDb vivado.pb -notrace -source irig.tcl
